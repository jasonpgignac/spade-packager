...
describe BPM::Packager::Package, "#to_spec" do
  ...
  subject do
    package = BPM::Packager::Package.new(email)
...
describe BPM::Packager::Package, "#to_s" do
  let(:email) { "user@example.com" }

  subject do
    package = BPM::Packager::Package.new
    package.json_path = fixtures("package.json")
    package.valid?
    package
  end
...
describe BPM::Packager::Package, "converting" do
  before do
    cd(home)
  end
...
describe BPM::Packager::Package, "validating" do
  before do
    cd(home)
  end

  subject { BPM::Packager::Package.new }
...
describe BPM::Packager::Package, "validation errors" do
  let(:email) { "user@example.com" }
  ...
  subject do
    BPM::Packager::Package.new(email)
  end
